...
// console.log(Soul)
class DAMAGETOPOISONINHALF {
  static NAME = 'DAMAGETOPOISONINHALF'
  static filename = 'DAMAGETOPOISONINHALF'
  ...
  constructor (effectObj = {}, target = {}, caster = {}) {
    ...
    return new Status({
      ...
      name: 'damagetopoisoninhalf',
      desc: '50% of incoming damage converted to poison',
      remove: [
        //
      ],
      effects: [
...
var obj = {
  filename: 'DAMAGETOPOISONINHALF',
  exprt: DAMAGETOPOISONINHALF
}
export default obj
